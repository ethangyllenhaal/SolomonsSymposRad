...
# Sankey plot of colonization order
sankey <- plot_ly(
  type="sankey",
  orientation="h",
  arrangement="snap",
  
  # make labels and colors for nodes
  node = list(
    label = c("Source",
  ...
  # set up the source, target, and value of each edge in three "parallel" vectors
  link = list(
    source = c(0,1,1,1,2,2,5,6,3,3, 9, 10,
    ...
    value = c(649,621,28,0,610,11,610,11,10,18,10,18,
